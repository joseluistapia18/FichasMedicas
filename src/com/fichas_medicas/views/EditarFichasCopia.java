 ...
 */
public class EditarFichasCopia extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public EditarFichasCopia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public EditarFichasCopia(java.awt.Frame parent, boolean modal, Usuario obj) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setSize(797, 685);
    ...
    public EditarFichasCopia(java.awt.Frame parent, boolean modal, FichaMedica objFM) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setSize(797, 685);
